    ...
    <div className="px-5 lg:px-20 py-2 border-primary-900 border-b-[0.5px] text-[6px] text-primary-900 lg:text-sm">
      <div className="flex justify-end">
        <ul className="flex items-center gap-2.5 list-none">
          <li>
            <Link className="flex items-center gap-1.5" to="tel:+23324-448-5242">
              <IconCall className="lg:w-6 lg:h-6 size-3" />
              <span className="hidden lg:block">+23324-448-5242</span>
            </Link>
          </li>
          <li>
            <Link to="https://wa.me/12069798033?text=Hi%2C%20I%20found%20you%20through%20your%20website" className="flex items-center gap-1.5">
              <IconWhatsapp className="lg:w-6 lg:h-6 size-3" />
              <span className="hidden lg:block">+1206-979-8033</span>
            </Link>
          </li>
          <li className="bg-primary-900 w-[0.5px] h-full"></li>
          <li className="flex justify-center items-center">
            <Link className="text-[10px] lg:text-sm" to={`mailto:${EMAIL}`}>
              {EMAIL}
            </Link>
          </li>
        </ul>
